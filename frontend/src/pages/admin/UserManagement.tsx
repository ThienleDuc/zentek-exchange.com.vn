...
import { Search, Plus, Eye, Edit, Trash2, Loader2, AlertCircle, Users, UserPlus, Shield } from 'lucide-react';
import {
...
const UserManagement: React.FC = () => {
  ...
  const [stats, setStats] = useState({ roles: [], last7Days: [] });
    ...
    <div className="min-h-screen p-6 max-w-7xl mx-auto flex flex-col gap-6 text-text-body">
      ...
      <div className="bg-surface backdrop-blur-md border border-border-default rounded-xl p-6 shadow-2xl flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-surface-muted rounded-lg p-4 border border-border-default">
            <h3 className="text-sm font-semibold text-text-main mb-4 flex items-center gap-2">
              <UserPlus className="w-4 h-4 text-secondary" /> Đăng ký mới (7 ngày)
            </h3>
            <div className="h-[220px] w-full flex items-center justify-center">
              {loadingStats ? (
